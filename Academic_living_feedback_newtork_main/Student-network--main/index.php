            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="academic.php" class="dropdown-item">Academic Help</a>
                        <a href="food.php" class="dropdown-item">Food Help</a>
                        <a href="living.php" class="dropdown-item">Living Help</a>
                        <a href="counselling.php" class="dropdown-item">Counseling Help</a>
                        <a href="network.php" class="dropdown-item">Network Help</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                ...
                <a href="connect.php" class="nav-item nav-link">Connect</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="connect.php" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Contact Us</a>
                        </div>
                    </div>
                </div>
